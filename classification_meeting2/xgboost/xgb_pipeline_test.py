...
def main():
    ...
    text_file_path = os.path.join(script_dir, "data.txt")
    label_file_path = os.path.join(script_dir, "labels.txt")
    
    # Fallback to absolute paths if needed
    # text_file_path = "C:\\Users\\USER\\Desktop\\AI_SG\\1\\xgboost\\data.txt"   # Each line: one document
    #label_file_path = "C:\\Users\\USER\\Desktop\\AI_SG\\1\\xgboost\\labels.txt"  # Each line: one label (same order as texts)
